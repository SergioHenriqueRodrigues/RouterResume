UI_STRINGS = {
    "pt": {
        ...
        "test_key_err_ratelimit": "⚠️ Limite de requisições atingido, tente novamente em instantes: {detail}",
    ...
    "en": {
        ...
        "test_key_err_ratelimit": "⚠️ Rate limit reached, try again in a moment: {detail}",
    ...
    "es": {
        ...
        "test_key_err_ratelimit": "⚠️ Límite de solicitudes alcanzado, intenta en un momento: {detail}",
